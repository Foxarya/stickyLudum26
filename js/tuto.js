...
var walls = [], tiles = [];
// The two containers for corresponding box2d and KineticJS objects to quickly access them
...
function loadCanvas() {
	...
	context = gameLayer.getContext();
	// initialize the context variable required for box2d draw function
